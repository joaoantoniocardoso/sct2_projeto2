...
void my_scia_send_uint16(Uint16 num)
{
    ...
    while(index--){
        str[index] = (num % BASE) + '0';     // gets each algarism
...
/**
 * @brief Sends an Uint32 through serial.
 */
void my_scia_send_uint32(Uint32 num)
{
    #define MAX_LEN         11  // "4294967296" is 6 characters with NULL terminator
    #define BASE            10  // decimal base
